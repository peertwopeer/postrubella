App.info({
  ...
  name: "postrubella",
  description: "Security within Wireless Technology",
  author: "org_placeholder",
  email: "postrubella@org_placeholder.io",
  website: "https://postrubella.org_placeholder.io",
  version: "23.14",
  buildNumber: "42",
});
App.icons({
  app_store: "resources/icons/ios_app_store.png", // 1024x1024
  iphone_2x: "resources/icons/ios_app_icon_2x.png", // 120x120
  iphone_3x: "resources/icons/ios_app_icon_3x.png", // 180x180
...
App.launchScreens({
  ...
  iphoneX_portrait: "resources/splashes/iphoneX_portrait.png", // 1125×2436
...
App.setPreference("StatusBarBackgroundColor", "#404144");
...
<string>The App needs to access your device camera in-order to scan the QR Code.</string>
</edit-config>`);
App.appendToConfig(`<edit-config target="NSPhotoLibraryUsageDescription" file="*-Info.plist" mode="merge">
<string>Need photo library access to get pictures from there.</string>
</edit-config>`);
App.appendToConfig(`<edit-config target="NSLocationWhenInUseUsageDescription" file="*-Info.plist" mode="merge">
<string>Need location access to find things nearby.</string>
</edit-config>`);
App.appendToConfig(`<edit-config target="NSPhotoLibraryAddUsageDescription" file="*-Info.plist" mode="merge">
